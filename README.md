...
**Downloads (desktop installers + browser extension)**: https://github.com/Onyedikachika/weather-app/releases/tag/v1.1.0
**Downloads (Android app)**: https://github.com/Onyedikachika/weather-app/releases/tag/v1.2.0
